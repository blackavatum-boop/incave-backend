# C:\MyIncaveProject\frontend\app.py
...
st.page_link("pages/2_consult_ai.py", label="หรือ คลิกที่นี่เพื่อปรึกษา AI โดยตรง", icon="💬")
st.markdown("---")
# ------------------------------------------
...
def get_quiz_data():
    ...
    results_guide = {
        ...
        'น้ำ': {'description': 'พลังแห่งการหล่อเลี้ยง มีอารมณ์อ่อนไหว ง่วงง่าย', 'behavior': 'ควรตื่นเช้ารับแดด เดินริมแม่น้ำ', 'herbs': 'เช่น ตะไคร้, บัวบก, กระเจี๊ยบ'},
...
def analyze_and_display_results(scores, results_guide):
    ...
    # ⭐ แก้ไขตรงนี้: เพิ่ม "2_" เข้าไปให้ถูกต้อง
    st.page_link("pages/2_consult_ai.py", label=f"คุยกับ AI เพื่อรับคำแนะนำสำหรับธาตุ {primary_element} ต่อ", icon="💬")
